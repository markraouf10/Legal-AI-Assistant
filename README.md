...
Prerequisites: A Google account and a free Groq API key from https://console.groq.com 
...
5. Scroll to Section 10 for the live Gradio demo link 
...
Legal-AI-Assistant/ 
|-- data/                          # Legal knowledge base (4 real PDFs) 
